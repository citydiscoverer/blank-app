...
def get_supabase():
    ...
    try:
        ...
        key = st.secrets["supabase"]["service_role_key"]  # make sure this EXACT key is in Secrets
        return create_client(url, key)
    except KeyError:
        st.error('Secrets missing. In Settings → Secrets add:\n[supabase]\nurl="..."\nservice_role_key="..."')
        return None
...
if sb: st.sidebar.success("Connected")
